...
const Portfolio = () => {
    ...
    const data = {
        ...
        BookMark: {name: 'BookMark', index: 5, title: 'BookMark Langing Page', img: BookMark, imgClass: 'ecomm', stack: ['HTML', 'SCSS', 'ReactJS']},
        CarRental: {name: 'CarRental', index: 6, title: 'Website for car rental service', img: CarRental, imgClass: 'gym', stack: ['HTML', 'SCSS', 'ReactJS']}
    };
